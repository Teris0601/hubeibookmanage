...
/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery) {var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;﻿/*! layer-v3.0.3 Web弹层组件 MIT License  http://layer.layui.com/  By 贤心 */
...
var mmHistory = __webpack_require__(14)
...
module.exports = "<div class=\"m-page m-page-rt\" ms-visible='@totalPages>1'>\n  <a ms-class='{z_dis: @isDisabled(\"first\", 1)}' ms-attr='{title:@getTitle(\"first\")}' ms-click='@cbProxy($event,\"first\")'>\n            {{@firstText}}\n        </a>\n  <a ms-class='{z_dis: @isDisabled(\"prev\",1)}' ms-attr='{title:@getTitle(\"prev\")}' ms-click='@cbProxy($event,\"prev\")'>\n            {{@prevText}}\n        </a>\n  <a ms-for='page in @pages' ms-class='{z_crt: page === @currentPage}' ms-attr='{title:@getTitle(page)}' ms-click='@cbProxy($event,page)'>\n            {{page}}\n        </a>\n  <a ms-class='{z_dis: @isDisabled(\"next\",@totalPages)}' ms-attr='{title: @getTitle(\"next\")}' ms-click='@cbProxy($event,\"next\")'>\n            {{@nextText}}\n        </a>\n  <a ms-class='{z_dis: @isDisabled(\"last\",@totalPages)}' ms-attr='{title: @getTitle(\"last\")}' ms-click='@cbProxy($event,\"last\")'>\n            {{@lastText}}\n        </a>\n</div>\n";
